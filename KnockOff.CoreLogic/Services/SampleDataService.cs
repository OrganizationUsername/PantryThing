...
namespace KnockOff.CoreLogic.Services
{
    ...
    {
        private static IEnumerable<SampleOrder> AllOrders() => AllCompanies().SelectMany(c => c.Orders);
        ...
        public Task<IEnumerable<SampleOrder>> GetContentGridDataAsync() => Task.FromResult(AllOrders());

        // Remove this once your DataGrid pages are displaying real data.
        public Task<IEnumerable<SampleOrder>> GetGridDataAsync() => Task.FromResult(AllOrders());

        // Remove this once your ListDetails pages are displaying real data.
        public Task<IEnumerable<SampleOrder>> GetListDetailsDataAsync() => Task.FromResult(AllOrders());
    }
}
