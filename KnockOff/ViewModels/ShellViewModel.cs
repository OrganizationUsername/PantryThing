...
namespace KnockOff.ViewModels
{
    public class ShellViewModel : ObservableObject
    {
        ...
        public RelayCommand GoBackCommand => _goBackCommand ?? (_goBackCommand = new(OnGoBack, CanGoBack));
        ...
        public ShellViewModel(INavigationService navigationService) => _navigationService = navigationService;
        ...
        private void NavigateTo(Type targetViewModel) { if (targetViewModel != null) { _navigationService.NavigateTo(targetViewModel.FullName); } }
